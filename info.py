...
API_ID = int(environ.get('API_ID', '28756250'))
API_HASH = environ.get('API_HASH', 'b3369aa5b23c06a89cbf4e8239ab2248')
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6419268641').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002300626820'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002403918178').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', 'https://t.me/allmovies90905') # give your force subscribe channel id here else leave it blank
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', 'https://t.me/moviesfinder98')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', 'https://t.me/+vGU4HZByp_Q1MDNl')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://shortpodcast85:c2eg1L5JUbY31cO4@cluster0.vj3yv.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "shortpodcast85")
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/allmovies90901')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/allmovies90905')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'moviesfinder98') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/speedy487')
...
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', '14617486a13dcd7512cafa88d524bd8a25879f8e')
